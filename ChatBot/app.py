...
class ChatApplication:
    ...
    def _setup_main_window(self):
        ...
        self.window.configure(width=1280, height=750, bg=BG_COLOR)
    ...
    # head label
        ...
        #tiny divider
        line = Label(self.window, width=450, bg=MAIN_BG)
        ...
        #bottom label
        bottom_label = Label(self.window, bg=MAIN_BG, height=80)
        ...
        #send button
        send_button = Button(bottom_label, text="Send", font=FONT_BOLD, width=20, bg='#FF0032',
